...
namespace SharpConnect.MySql
{
    ...
    public class MySqlConnectionString
    {
        ...
        #region 构造函数
        public MySqlConnectionString(string Host, string UserName, string Password, string DataBase) : this(Host, UserName, Password, DataBase, 3306)
        {
        }
        public MySqlConnectionString(string Host, string Username, string Password, string Database, int Port)
        {
            this.Host = Host;
            this.Username = Username;
            this.Password = Password;
            this.Database = Database;
            this.PortNumber = 3306;//default mysql port
            _signature = string.Concat(Host, Username, Database, this.PortNumber);
        }
        #endregion
